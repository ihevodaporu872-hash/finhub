...
interface IProps {
  ...
  onProjectChange: (projectId: string | null, project: Project | null, allProjects: Project[]) => void;
}
    ...
    <div className="dashboard-toolbar">
      ...
      <div className="dashboard-project-tags">
        <Tag.CheckableTag
          ...
          onChange={() => onProjectChange(null, null, projects)}
        >
          Все проекты
        </Tag.CheckableTag>
        {projects.map((p) => (
          <Tag.CheckableTag
            ...
            onChange={(checked) => onProjectChange(checked ? p.id : null, checked ? p : null, projects)}
          >
            {p.name}
          </Tag.CheckableTag>
        ))}
