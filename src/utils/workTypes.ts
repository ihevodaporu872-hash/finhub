...
const WORK_TYPE_ALIASES: Record<string, string[]> = {
  ...
  monolith: ['конструкции железобетонные', 'железобетонные конструкции', 'жб конструкции'],
  masonry: ['каменные конструкции'],
  waterproofing: ['устройство гидроизоляции', 'изоляционные работы'],
  interior: ['внутренние отделочные работы'],
  external_networks: ['наружные инженерные сети'],
